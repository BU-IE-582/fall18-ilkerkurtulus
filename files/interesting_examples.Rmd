...
1. While discovering titanic dataset i encountered that loading data stored in local to the github is a bit tricky.
Example:
```{r eval=TRUE}
# df = read.csv('/files/train.csv')
print(getwd())
...
To overcome that there is useful notebook in Kaggle:
